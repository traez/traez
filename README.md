...
- 👀 My **body of work** are in my [**Repositories**](https://github.com/traez?tab=repositories). While the wider collection of my code interests can be seen categorized when you click the [**Stars link**](https://github.com/traez?tab=stars)  
- ⚡ For recruiters though, my most notable projects are all contained in [**my Portfolio**](https://github.com/stars/traez/lists/portfolio)  
